...
// TODO: PrductReviewMutation


/**
 * __useUpdateProductReview__
 *
 * To run a mutation, you first call `useUpdateProductReview` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateProductReview` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [UpdateProductReview, { data, loading, error }] = useUpdateProductReview({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useUpdateProductReview(baseOptions?: ApolloReactHooks.MutationHookOptions<Types.UpdateProductReview, Types.UpdateProductReviewVariables>) {
  const options = {...defaultOptions, ...baseOptions}
  return ApolloReactHooks.useMutation<Types.UpdateProductReview, Types.UpdateProductReviewVariables>(ProductDeleteDocument, options);
}
// export type UpdateProductReviewHookResult = ReturnType<typeof useUpdateProductReview>;
// export type UpdateProductReviewResult = Apollo.MutationResult<Types.UpdateProductReview>;
// export type UpdateProductReviewOptions = Apollo.BaseMutationOptions<Types.UpdateProductReview, Types.UpdateProductReviewVariables>;
...
export function useReviewDetailsQuery(baseOptions: ApolloReactHooks.QueryHookOptions<Types.ReviewDetailsQuery, Types.ReviewDetailsQueryVariables>) {
  const options = {...defaultOptions, ...baseOptions}
  return ApolloReactHooks.useQuery<Types.ReviewDetailsQuery, Types.ReviewDetailsQueryVariables>(ReviewDetailsDocument, options);
}